...
LDFLAGS		= $(MOZ_LTO_LDFLAGS) $(COMPUTED_LDFLAGS) $(PGO_LDFLAGS) -Wl,-rpath-link,/usr/local/lib /usr/local/lib/libhiredis.a

COMPILE_CFLAGS	= $(MOZ_LTO_CFLAGS) $(COMPUTED_CFLAGS) $(PGO_CFLAGS) $(_DEPEND_CFLAGS) $(MK_COMPILE_DEFINES) -lhiredis -I /usr/local/include/hiredis
COMPILE_CXXFLAGS = $(MOZ_LTO_CFLAGS) $(COMPUTED_CXXFLAGS) $(PGO_CFLAGS) $(_DEPEND_CFLAGS) $(MK_COMPILE_DEFINES) -lhiredis -I /usr/local/include/hiredis
COMPILE_CMFLAGS = $(MOZ_LTO_CFLAGS) $(OS_COMPILE_CMFLAGS) $(MOZBUILD_CMFLAGS) -lhiredis -I /usr/local/include/hiredis
COMPILE_CMMFLAGS = $(MOZ_LTO_CFLAGS) $(OS_COMPILE_CMMFLAGS) $(MOZBUILD_CMMFLAGS) -lhiredis -I /usr/local/include/hiredis
...
#HOST_C_LDFLAGS = $(COMPUTED_HOST_C_LDFLAGS) -Wl,-rpath-link,/usr/local/lib /home/jb/.mozbuild/sysroot-x86_64-linux-gnu/usr/lib/x86_64-linux-gnu/libhiredis.a
#HOST_CXX_LDFLAGS = $(COMPUTED_HOST_CXX_LDFLAGS) -Wl,-rpath-link,/usr/local/lib /home/jb/.mozbuild/sysroot-x86_64-linux-gnu/usr/lib/x86_64-linux-gnu/libhiredis.a
