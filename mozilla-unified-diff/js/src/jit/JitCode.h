...
class JitCode : public gc::TenuredCellWithNonGCPointer<uint8_t> {
 ...
 public:
  ...
  bool hasBytecodeMap() {
    return hasBytecodeMap_;
  }

  void setInstructionsSize(size_t instructionsSize) {
    insnSize_ = instructionsSize;
  }
  void setJumpRelocTableBytes(size_t jumpRelocTableBytes) {
    jumpRelocTableBytes_ = jumpRelocTableBytes;
  }
  void setDataRelocTableBytes(size_t dataRelocTableBytes) {
    dataRelocTableBytes_ = dataRelocTableBytes;
  }
